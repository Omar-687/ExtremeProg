...
public class BorrowingDateControllerTest {
    ...
    public void testController() {
        ...
        Book book1 = new Book("t1", "a1", Date.valueOf("2000-1-1"), Date.valueOf("2023-4-15"));
        Book book2 = new Book("t2", "a2", Date.valueOf("2000-1-1"), Date.valueOf("2023-3-10"));
        ...
        List<Book> booksToBeReturned = borrowingDateController.getBooksToBeReturned(List.of(book1, book2, book3, book4, book5, book6));
